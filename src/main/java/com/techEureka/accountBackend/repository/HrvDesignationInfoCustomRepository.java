...
public class HrvDesignationInfoCustomRepository {
	...
	public List<HrvDesignationInfo> findAllHrvDesignationInfos(){
		...
		List<HrvDesignationInfo> hrvDesignationInfos = jdbcTemplate.query(query, (rs,rowmap) ->{
			...
			HrvDesignationInfo hrvDesignationInfo =new HrvDesignationInfo(rs.getLong("DESGTON_ID"), rs.getString("DESIG_NAME"), rs.getLong("PTG_DIG_ID"), rs.getString("PDESG_NAME"), rs.getInt("ASTATUS_FG"), rs.getLong("USERDSL_NO"), rs.getLong("CREATED_BY"), rs.getDate("CREATED_AT"), rs.getLong("UPDATED_BY"), rs.getDate("UPDATED_AT"), rs.getLong("DIG_STR_ID"), rs.getString("DSGSTRNAME"), rs.getString("DESIG_CODE"), rs.getInt("RECSHOW_FG"));
