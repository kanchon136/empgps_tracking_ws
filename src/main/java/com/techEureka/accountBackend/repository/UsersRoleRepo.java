...
public interface UsersRoleRepo extends JpaRepository<UsersRole, Long>{
    ...
    void assignRoleForUser(@Param("role") String role, @Param("specPagePermission") String specPagePermission, @Param("userId") Long userId);
	...
	void giveSpecPagePermission(@Param("userName") String userName, @Param("specPagePermission") String specPagePermission);
