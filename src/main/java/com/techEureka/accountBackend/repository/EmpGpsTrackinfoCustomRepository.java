...
public class EmpGpsTrackinfoCustomRepository {
	...
	public List<EmployeeGpsTrackInfo> findEmpgpsTrackInfosByEmpno(){
		...
		String query =" select GPSDATA_ID, MKGPROF_NO,EMPLOYE_NO ,EMPLOYE_NM,"
				...
				+ "  PWRSV_MODE,LOCSHAR_TYP,TOOLTIPTXT,PROF_PHOTO "
				+ " from  HRV_GPSDATA ";
		...
		List<EmployeeGpsTrackInfo> employeeGpsTrackInfos = jdbcTemplate.query(query, (rs,rownum) ->{
			...
			EmployeeGpsTrackInfo employeeGpsTrackInfo = new EmployeeGpsTrackInfo(rs.getString("GPSDATA_ID"),
					rs.getString("MKGPROF_NO"),rs.getString("EMPLOYE_NO"),
					rs.getString("EMPLOYE_NM"),rs.getDate("GPSDATA_DT"),rs.getString("GPSDATA_TM"),
					rs.getFloat("M_LATITUDE"),rs.getFloat("M_LONGITDE"),rs.getInt("GPSDATA_FG"),
					rs.getString("SAUSERS_ID"),rs.getDate("GPSDTA_DTM"),rs.getString("GPSLOCA_NM"),
					rs.getString("BATERY_PCT"),rs.getString("INTCXN_TYP"),rs.getString("PWRSV_MODE"),
					rs.getString("LOCSHAR_TYP"),rs.getString("TOOLTIPTXT"),rs.getString("PROF_PHOTO"));
